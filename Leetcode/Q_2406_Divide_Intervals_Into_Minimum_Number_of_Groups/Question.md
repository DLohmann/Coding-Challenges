...
# Question 2406: [Divide Intervals Into Minimum Number of Groups](https://leetcode.com/problems/divide-intervals-into-minimum-number-of-groups/description/)
...
```bash
bazel test --test_output=all //Leetcode/Q_2406_Divide_Intervals_Into_Minimum_Number_of_Groups:all
```
