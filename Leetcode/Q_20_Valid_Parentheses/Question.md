...
**This question also appears on the Meta Careers website's interview prep coding question course [under the title "Balance Brackets"](https://www.metacareers.com/profile/coding_practice_question/?problem_id=211548593612944)**
...
```bash
bazel test --test_output=all "//Leetcode/Q_20_Valid_Parentheses:Sample_test"
```
